...
/**
 * Creates InChI(s) from the current model, to be displayed to user in pop out
 * window.
 * 
...
public class CreateInChIAction extends JCPAction {
	...
	public void actionPerformed(final ActionEvent e) {
		...
		final ChemModel model = (ChemModel) jcpPanel.getChemModel();
		if (model.getReactionSet() != null
			...
			final StringBuffer dialogText = new StringBuffer();
			int i = 0;
			final String eol = System.getProperty("line.separator");
			for (final IAtomContainer container : model.getMoleculeSet()
					.atomContainers()) {
