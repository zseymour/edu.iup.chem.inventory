 ...
 * @author Zach
 */
public class WasteWizardPage extends WizardPage {
	...
	/**
	 * Creates new form WasteWizardPage
	 */
	public WasteWizardPage(final WizardSettings settings) {
		super("Enter bottle information",
				"Enter the bottle number and description for this waste container.");
	...
	private void initComponents() {
		...
		amount = new javax.swing.JTextField(5);
		...
		jLabel1.setLabelFor(bottle);
		jLabel1.setText("Bottle Number");

		bottle.setName("bottle"); // NOI18N
		bottle.setText("W" + LocationDao.getNextAvailableBottle());

		jLabel2.setLabelFor(description);
		jLabel2.setText("Description of Contents:");
		...
		room.setSelectedItem(RoomDao.getDefaultRoom("Weyandt 126"));
