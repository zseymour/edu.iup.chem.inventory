...
public class CompoundIcon implements Icon {
	 ...
	 */
	private int getOffset(final int maxValue, final int iconValue,
	...
	public void paintIcon(final Component c, final Graphics g, int x, int y) {
		if (axis == Axis.X_AXIS) {
			...
			for (final Icon icon : icons) {
				final int iconY = getOffset(height, icon.getIconHeight(),
						alignmentY);
			...
			for (final Icon icon : icons) {
				final int iconX = getOffset(width, icon.getIconWidth(),
						alignmentX);
